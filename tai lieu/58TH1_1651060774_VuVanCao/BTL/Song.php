...
<?php include 'header.php'?>
    <div class="container">
        <?php
              ...
              $result = pg_query($dbconn,"SELECT * FROM song_polygon ORDER BY gid");
        ?>
      <div class="row">
        <div class="col-8"><h1>Dữ Liệu Sông</h1></div>
        <div class="col-4"><form action="export.php" method="POST" class="pull-right">
          <input type="submit" name="export_song" class="btn btn-success export" value="export">
        </form>
      </div>
      </div>
        ...
        <form action="process.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <input type="submit" value="Update" name="update_song" class="btn btn-primary">
          </div>
        </form>
      </div>
    </div>
