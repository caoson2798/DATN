...
<body>
    ...
    <div class="container">
        ...
        <p class="d-flex w-100 justify-content-center my-3 font-italic" style="font-size: 20px;">Tổng có tất cả 162 công trình cống</p>
    </div>
    <script>
        var xValues = ["Tốt", "Trung bình", "Kém"];
        var yValues = [60, 80, 22];
        var barColors = [
            "#00aba9",
            "#2b5797",
            "#b91d47",
        ...
        new Chart("myChart", {
            ...
            options: {
                title: {
                    display: true,
                    text: "Thống kê tình trạng công trình cống dưới đê"
                }
            }
        });
    </script>
